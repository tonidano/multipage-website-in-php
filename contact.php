...
<div class="container-fluid aboutContainer">
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header"><strong>Qui sommes nous ?</strong></div>
        <div class="card-body">
          <div class="row about">
              ...
              <div class="col-12">
                  <p style="text-align:justify;">L’asbl Loupiote est composée d’une équipe de professionnels du cinéma et de pédagogues qui développent des ateliers itinérants d’éducation au et par le cinéma dans les milieux associatifs et scolaires.</p>
                  <p style="text-align:justify;">Loupiote est parrainée par les cinéastes Frédéric Fonteyne, Marion Hänsel, Bouli Lanners, Benoît Mariage, Pierre-Paul Renders et Jaco Van Dormael et aussi par Thomas d’Ansembourg (thérapeute et formateur en Communication Non Violente).</p>
              </div>
              <div class="col-12 aboutPic">
